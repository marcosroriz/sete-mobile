                ...
                <NavigationContainer>
                    {isLogged ? (
                        <Stack.Navigator initialRouteName="DashboardScreen">
                            ...
                            />
                            <Stack.Screen
                                name="AlunosMapScreen"
                                component={AlunosMapScreen}
                                options={{ headerShown: false }}
                            />
                            <Stack.Screen
                                name="GenerateRouteScreen"
                                component={GenerateRouteScreen}
                                options={{ headerShown: false }}
                            />
                            <Stack.Screen
                                name="OverviewScreen"
                            ...
                            />
                            <Stack.Screen
                                name="RotasPercorrerScreen"
                                component={RotasPercorrerScreen}
                                options={{ headerShown: false }}
                            />
                            <Stack.Screen
